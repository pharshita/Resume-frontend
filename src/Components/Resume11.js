                          ...
                          items.Experience[0] === undefined ? "" :
                            ...
                            <div style={{ marginTop: "10px" }}>
                              ...
                              <div className="borderbox">
                                ...
                                {/* <h5 style={{ fontSize: "17px", marginBottom: "30px" }}>{items.Experience[0].start_date} to current</h5> */}
                      ...
                      <div style={{ margin: "10px 0px" }} >
                        {
                          items.Education[0] === undefined ? "" :
                            ...
                            <div style={{ marginTop: "10px" }}>
                              <h5 style={{ textTransform: "capitalize", fontSize: "17px", backgroundColor: "#958e8e29", padding: "5px" }}>{items.Education[0].degree} </h5>

                              <div className="borderbox">
                                <h5 style={{ fontSize: "17px", marginBottom: "30px" }}>{items.Education[0].start_date} to {items.Education[0].end_date}</h5>
                        ...
                        }
                        {
                          items.Education[1] === undefined ? "" :
                            ...
                            <div style={{ marginTop: "10px" }}>
                              <h5 style={{ textTransform: "capitalize", fontSize: "17px", backgroundColor: "#958e8e29", padding: "5px" }}>{items.Education[1].degree} </h5>

                              <div className="borderbox">
                                <h5 style={{ fontSize: "17px", marginBottom: "30px" }}>{items.Education[1].start_date} to {items.Education[1].end_date}</h5>
                        ...
                        }
                        {
                          items.Education[2] === undefined ? "" :
                            ...
                            <div style={{ marginTop: "10px" }}>
                              <h5 style={{ textTransform: "capitalize", fontSize: "17px", backgroundColor: "#958e8e29", padding: "5px" }}>{items.Education[2].degree} </h5>

                              <div className="borderbox">
                                <h5 style={{ fontSize: "17px", marginBottom: "30px" }}>{items.Education[2].start_date} to {items.Education[2].end_date}</h5>
                        ...
                        }
                        {
                          items.Education[3] === undefined ? "" :
                            ...
                            <div style={{ marginTop: "10px" }}>
                              <h5 style={{ textTransform: "capitalize", fontSize: "17px", backgroundColor: "#958e8e29", padding: "5px" }}>{items.Education[3].degree} </h5>

                              <div className="borderbox">
                                <h5 style={{ fontSize: "17px", marginBottom: "30px" }}>{items.Education[3].start_date} to {items.Education[3].end_date}</h5>
                        ...
                        }
                        {
                          items.Education[4] === undefined ? "" :
                            ...
                            <div style={{ marginTop: "10px" }}>
                              <h5 style={{ textTransform: "capitalize", fontSize: "17px", backgroundColor: "#958e8e29", padding: "5px" }}>{items.Education[4].degree} </h5>

                              <div className="borderbox">
                                <h5 style={{ fontSize: "17px", marginBottom: "30px" }}>{items.Education[4].start_date} to {items.Education[4].end_date}</h5>
                        ...
                        }
                        {
                          items.Education[5] === undefined ? "" :
                            ...
                            <div style={{ marginTop: "10px" }}>
                              <h5 style={{ textTransform: "capitalize", fontSize: "17px", backgroundColor: "#958e8e29", padding: "5px" }}>{items.Education[5].degree} </h5>

                              <div className="borderbox">
                                <h5 style={{ fontSize: "17px", marginBottom: "30px" }}>{items.Education[5].start_date} to {items.Education[5].end_date}</h5>
