                                            ...
                                            <div>
                                                ...
                                                <div className='pl-3'>
                                                    ...
                                                    <div className='d-flex pt-4' style={{ justifyContent: "space-between" }}>
                                                        ...
                                                        <div className=''>
                                                            <p style={{ textAlign: "end", color: "#018bb7", fontWeight: "bold" }}>{items.Education[0].start_date} to {items.Education[0].end_date}</p>
                                                    ...
                                                    items.Education[1] === undefined ? "" :
                                                        <div className='pl-3'>
                                                            ...
                                                            <div className='d-flex pt-4' style={{ justifyContent: "space-between" }}>
                                                                ...
                                                                <div className=''>
                                                                    <p style={{ textAlign: "end", color: "#018bb7", fontWeight: "bold" }}>{items.Education[1].start_date} to {items.Education[1].end_date}</p>
                                                    ...
                                                    items.Education[2] === undefined ? "" :
                                                        <div className='pl-3'>
                                                            ...
                                                            <div className='d-flex pt-4' style={{ justifyContent: "space-between" }}>
                                                                ...
                                                                <div className=''>
                                                                    <p style={{ textAlign: "end", color: "#018bb7", fontWeight: "bold" }}>{items.Education[2].start_date} to {items.Education[2].end_date}</p>
                                                    ...
                                                    items.Education[3] === undefined ? "" :
                                                        <div className='pl-3'>
                                                            ...
                                                            <div className='d-flex pt-4' style={{ justifyContent: "space-between" }}>
                                                                ...
                                                                <div className=''>
                                                                    <p style={{ textAlign: "end", color: "#018bb7", fontWeight: "bold" }}>{items.Education[3].start_date} to {items.Education[3].end_date}</p>
                                                    ...
                                                    items.Education[4] === undefined ? "" :
                                                        <div className='pl-3'>
                                                            ...
                                                            <div className='d-flex pt-4' style={{ justifyContent: "space-between" }}>
                                                                ...
                                                                <div className='col-sm-6'>
                                                                    <p style={{ textAlign: "end", color: "#018bb7", fontWeight: "bold" }}>{items.Education[4].start_date} to {items.Education[4].end_date}</p>
